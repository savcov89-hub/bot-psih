...
async def send_welcome(message: Message, state: FSMContext):
    ...
    if is_subscribed:
        ...
        await message.answer(f"{welcome_text}\n\nЧтобы начать, нажмите кнопку ниже.", reply_markup=agree_keyboard, parse_mode="Markdown")
...
def main() -> None:
    ...
    scheduler.add_job(charge_recurring_payments, 'cron', hour=10, minute=0) # Раз в день в 10:00 UTC
    scheduler.start()
